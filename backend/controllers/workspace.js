...
import { sendEmail } from "../libs/bravo-email.js";
import { recordActivity } from "../libs/index.js";
import { isWorkspaceMember } from "../libs/access.js";
import { primaryFrontendUrl } from "../libs/frontend-url.js";
...
const getWorkspaceDetails = async (req, res) => {
    try {
        const workspace = await Workspace.findOne({ _id: req.params.workspaceId }).populate("members.user", "name email profilePicture");
        if (!workspace) {
...
const inviteUserToWorkspace = async (req, res) => {
    try {
        ...
        const invitationLink = `${primaryFrontendUrl()}/dashboard/workspaces/workspace-invite/${workspace._id}?tk=${inviteToken}`;
